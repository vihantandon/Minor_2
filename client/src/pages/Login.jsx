    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 440 }} className="anim-up">
        ...
        <h1
          ...
          style={{ fontSize: "3.2rem", lineHeight: 1, marginBottom: 32 }}
        >
        ...
        >
          {[
            ...
            <button
              key={i}
              onClick={() => toast.success("// OAUTH COMING SOON")}
              style={{
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
        ...
        >
          ...
          <div>
            ...
            <input
              className="input"
              type="email"
              placeholder="krish@olympiad.com"
              required
              value={form.email}
              onChange={(e) =>
          ...
          <button
            ...
            type="submit"
            disabled={loading}
            style={{ marginTop: 8, opacity: loading ? 0.6 : 1, width: "100%" }}
          >
            {loading
              ? "// AUTHENTICATING..."
              : mode === "login"
